...
<!--============================================-->
 ...
 <!--============================================-->
        <li>
            ...
            <ul>
                <li> <a href="{{ route('all.testimonial') }}"><i class='bx bx-radio-circle'></i>All Testimonial</a></li>
      ...
      <!--============================================-->
       <li>
            <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Manage Booking Report</div>
            </a>
            <ul>
         ...
         <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('all.roles') }}"><i class='bx bx-radio-circle'></i>All Roles </a>
                    ...
                    <li> <a href="{{ route('add.roles.permission') }}"><i class='bx bx-radio-circle'></i>Add Role In Permission </a></li> 
