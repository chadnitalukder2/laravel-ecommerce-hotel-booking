    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form  id="myForm" class="row g-3" action="{{ route('update.blog.post') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea name="long_descp" class="form-control" rows="5" >{{ $post->long_descp }}</textarea>
                    </div>
