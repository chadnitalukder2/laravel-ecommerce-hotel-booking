    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form  id="myForm" class="row g-3" action="{{ route('update.gallery') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-6 form-group">
                       ...
                       <img src="{{ asset($gallery->photo_name) }}"  width="70px" height="70px" id="showImage">
